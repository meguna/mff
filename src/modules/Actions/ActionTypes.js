...
export const FETCH_MORE_RECIPES_START = 'FETCH_RECIPES_START';
export const FETCH_MORE_RECIPES_SUCCESS = 'FETCH_RECIPES_SUCCESS';
export const FETCH_MORE_RECIPES_FAILURE = 'FETCH_RECIPES_FAILURE';
